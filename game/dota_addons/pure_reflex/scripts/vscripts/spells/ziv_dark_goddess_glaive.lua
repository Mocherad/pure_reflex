...
function SpawnGlaive( keys )
    ...
    local glaive = CreateUnitByName("npc_dummy_sphere",caster:GetAbsOrigin(), false, nil, nil, caster:GetTeam())
   ...
   ability:ApplyDataDrivenModifier(caster, glaive, "modifier_glaive_unit",{})
    ...
    local particle = ParticleManager:CreateParticle("particles/dark_goddess_glaive_alt.vpcf",PATTACH_ABSORIGIN_FOLLOW,glaive)
 
    local projectile_speed = 6540
